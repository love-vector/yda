...
import org.vector.yda.persistance.dao.IntentionDao;
import org.vector.yda.util.mapper.IntentionMapper;
...
public class IntentionService {
    ...
    public URI createIntention(final IntentionDto intentionDto) {
        var intention = intentionDao.createIntention(intentionMapper.createEntity(intentionDto));

...
@WebServlet(SlackOAuthInstallController.URL_PATTERN)
public class SlackOAuthInstallController extends SlackOAuthAppServlet {

    public static final String URL_PATTERN = "/slack/oauth/start";

    public SlackOAuthInstallController(final App app) {
        super(app);
    }
}

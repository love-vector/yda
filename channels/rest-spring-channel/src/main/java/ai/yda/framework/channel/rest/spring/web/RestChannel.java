...
public class RestChannel implements Channel<RagRequest, RagResponse> {
    ...
    /**
     * Processes the incoming {@link RagRequest} by delegating it to the {@link Assistant}.
     *
     * <p>
     * This method is mapped to the HTTP POST method and handles the logic for processing a validated
     * {@link RagRequest}. The request is passed to the assistant, which performs the necessary operations

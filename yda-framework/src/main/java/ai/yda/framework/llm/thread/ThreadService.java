...
public class ThreadService {
    ...
    public Thread createThread(final String message) {
        return openAiService.createThread(ThreadMapper.INSTANCE.toThreadRequest(message));
    }
    ...
    public Message addMessage(final String threadId, final String message) {
        return openAiService.createMessage(threadId, ThreadMapper.INSTANCE.toMessageRequest(message));
    }
}

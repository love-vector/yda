...
/**
 * A transformer that resolves and enhances the {@link RagRequest} by adding context from previous interactions.
 *
...
public class ContextResolver implements RequestTransformer<RagRequest> {
    ...
    /**
     * Constructs a new {@link ContextResolver} with the specified assistant service, session provider,
     * and assistant ID for resolving context in requests.
     *

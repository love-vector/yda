...
public class BaseGenerator implements Generator<BaseRagRequest, BaseRagContext, BaseRagResponse> {

    private final ChatModel chat;

    @Override
    public BaseRagResponse generate(BaseRagRequest request, BaseRagContext context) {

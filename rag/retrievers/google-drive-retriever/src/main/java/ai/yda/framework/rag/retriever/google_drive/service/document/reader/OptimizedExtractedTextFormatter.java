 ...
 */
@Slf4j
public final class OptimizedExtractedTextFormatter {
     ...
     */
    private OptimizedExtractedTextFormatter(Builder builder) {
     ...
     */
    public static OptimizedExtractedTextFormatter defaults() {
     ...
     * <p>
     *     <strong>Note:</strong> This method has been modified from the original class to enhance its efficiency.
     *     The regular expression has been optimized for better performance.
     * </p>
     *
    ...
    public static String trimAdjacentBlankLines(String pageText) {
        log.warn("This is a temporary replacement for the original class ExtractedTextFormatter,"
                + " which optimized regular expression for adjacent blank lines into a single blank line. " +
                "It should be removed as soon as Spring AI introduces the necessary changes.");
     ...
     * {@link OptimizedExtractedTextFormatter} designed to facilitate the creation and
     * customization of instances of {@link OptimizedExtractedTextFormatter}.
     *
     * <p>
     * It allows for a step-by-step, fluent construction of the
     * {@link OptimizedExtractedTextFormatter}, by providing methods to set specific configurations
     ...
     * new instance of {@link OptimizedExtractedTextFormatter} with the specified configurations.
     * </p>
     *
     * @see OptimizedExtractedTextFormatter
     */
    public static class Builder {
        ...
        /**
         * Constructs and returns an instance of {@link OptimizedExtractedTextFormatter} using the
         * configurations set on this builder.
         *
         * <p>
         * This method uses the values set on the builder to initialize the configuration
         * for the {@link OptimizedExtractedTextFormatter} instance. If no values are explicitly
         ...
         * that each {@link OptimizedExtractedTextFormatter} object is configured as intended.
         * </p>
         *
         * @return a new instance of {@link OptimizedExtractedTextFormatter} configured with the
         * values set on this builder.
         */
        public OptimizedExtractedTextFormatter build() {
            return new OptimizedExtractedTextFormatter(this);
        }

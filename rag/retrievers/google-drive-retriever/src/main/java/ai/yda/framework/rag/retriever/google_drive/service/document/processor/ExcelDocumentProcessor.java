...
import ai.yda.framework.rag.retriever.google_drive.service.document.reader.OptimizedExtractedTextFormatter;
import ai.yda.framework.rag.retriever.google_drive.service.document.reader.SplitSheetBodyContentHandler;
import ai.yda.framework.rag.retriever.google_drive.service.document.reader.TikaExcelDocumentReader;
...
public class ExcelDocumentProcessor implements DocumentProcessor {
    ...
    public List<DocumentContentDTO> processDocument(
        ...
        return new TikaExcelDocumentReader(
                        ...
                        OptimizedExtractedTextFormatter.defaults())
                .get().stream()

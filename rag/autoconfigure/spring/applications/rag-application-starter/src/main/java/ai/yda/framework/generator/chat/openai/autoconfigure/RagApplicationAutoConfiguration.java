...
@AutoConfiguration
public class RagApplicationAutoConfiguration {

    @Bean
    public DefaultRagApplication defaultRagApplication(
        ...
        return new DefaultRagApplication(retrievers, augmenters, generator);
    }
}
